...
module.exports = [
    ...
    {
        method: 'GET',
        path: '/rules/assignAnalyticsId/{id}',
        config: {
            tags: ['api'],
            description: 'Get id rules data',
            notes: 'Get id rules data',
        ...
        handler: (request, reply) => {
            db.collection('rules').find().make((builder) => {
                builder.where('assignAnalyticsId', request.params.id);
                builder.first();
                builder.callback((err, res) => {
                    if (!res) {
                        return reply({
    ...
    },
    {
        ...
        handler: (request, reply) => {
            ...
            if (payload) {
                ...
                if (typeof validate.assignAnalyticsId == "undefined" && typeof validate.type == "undefined" && typeof validate.day == "undefined" && typeof validate.timeStart == "undefined" && typeof validate.timeEnd == "undefined" && typeof validate.value == "undefined") {
